...
# environmentName: "C5-Reference-AWS Environment"
# deploymentName: "C5-Reference-AWS Deployment"
...
provider {
    ...
    # launched with an IAM role.
     ...
     secretAccessKey: ENTER_YOUR_SECRET
...
ssh {
    ...
    privateKey: /tmp/test.pem # with an absolute path to .pem file
}
...
instances {
  ...
  t2m : ${common-instance-properties} {   # only suitable as a gateway
    type: t2.medium
  }
...
databaseServers {
    ...
    rds-mysql-dev26 {
      ...
      dbSubnetGroupName: cloudera
      vpcSecurityGroupIds: sg-3ab48442
      allocatedStorage: 10
...
cloudera-manager {
    ...
    # #    Principal@YOUR.KDC.REALM
     krbAdminUsername: "cloudera/admin@WHISKEY.JONNY.COM"
    #
    # # The password for the administrative Kerberos account.
     krbAdminPassword: "abc123"
    #
    ...
    databaseTemplates {
        CLOUDERA_MANAGER {
            name: scmt
            databaseServerName: rds-mysql-dev26
    ...
    repository: "http://archive.cloudera.com/cm5/redhat/6/x86_64/cm/5.7.1/"
...
cluster {
    ...
    parcelRepositories: ["http://archive.cloudera.com/cdh5/parcels/5.7.1/"]
    ...
    databaseTemplates: {
        HIVE {
            name: hivet
            databaseServerName: rds-mysql-dev26 # Must correspond to an external database server named above
